...
import com.winto.develop.ShenBao.activity.CheckedHistoryInfoActivity;
import com.winto.develop.ShenBao.adapter.CheckedHistoryListAdapter;
...
public class CheckedHistoryFragment extends BaseFragment {
    private SmartRefreshLayout srl_refresh;
    private RecyclerView rv_list;
    private View layout_empty;

    private CheckedHistoryListAdapter adapter;
    private int page = 1;
    ...
    protected void initAdapter() {
        ...
        adapter = new CheckedHistoryListAdapter(context, troubleList, 2);
    ...
    protected void initClick() {
        adapter.setOnItemClickListener(bean -> {
            ...
            toClass(context, CheckedHistoryInfoActivity.class, bundle);
        });
    ...
    protected int setLayout() {
        return R.layout.fragment_check_passed;
    }
}
