...
public class CheckedHistoryListAdapter extends RecyclerView.Adapter<CheckedHistoryListAdapter.TaskViewHolder> {
    private Context context;
    private List<HistoryListBean.DataBean> list;
    private OnItemClickListener listener;
    private int states;

    public CheckedHistoryListAdapter(Context context, List<HistoryListBean.DataBean> list, int states) {
    ...
    public TaskViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_checked_history_list, parent, false);
    ...
    public void onBindViewHolder(@NonNull TaskViewHolder holder, int position) {
        ...
        holder.tv_personnel.setText(bean.getReportUserName());
        holder.tv_level.setText(bean.getHiddenDangerLevel());
        holder.tv_time.setText(bean.getReTime());
